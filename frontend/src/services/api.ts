...
export const chatAPI = {
  ...
  sendMessage: (conversationId: number, content: string, useSSHAgent?: boolean, selectedServerIds?: number[]) =>
    api.post(`/chat/conversations/${conversationId}/messages`, { content, useSSHAgent, selectedServerIds }),
